...
Comprehensive performance optimization guide for React applications, designed for AI agents and LLMs. Contains 45+ rules across 7 categories, prioritized by impact from critical (eliminating waterfalls, reducing bundle size) to incremental (advanced patterns). Each rule includes detailed explanations, real-world examples comparing incorrect vs. correct implementations, and specific impact metrics to guide automated refactoring and code generation.
...
1. [Eliminating Waterfalls](#1-eliminating-waterfalls) — **CRITICAL**
   ...
   - 1.3 [Prevent Waterfall Chains in Async Functions](#13-prevent-waterfall-chains-in-async-functions)
...
5. [Rendering Performance](#5-rendering-performance) — **MEDIUM**
   ...
   - 5.7 [Use useTransition Over Manual Loading States](#57-use-usetransition-over-manual-loading-states)
...
### 1.3 Prevent Waterfall Chains in Async Functions
...
Use Suspense boundaries to show wrapper UI immediately while heavy components or data load.

**Incorrect: heavy component included in main bundle**

```tsx
import { HeavyDataDisplay } from "./HeavyDataDisplay";
...
The entire layout waits for the heavy component to load before anything renders.

**Correct: wrapper shows immediately, heavy component loads in background**

```tsx
import { lazy, Suspense } from "react";

const HeavyDataDisplay = lazy(() => import("./HeavyDataDisplay"));
...
Sidebar, Header, and Footer render immediately. Only HeavyDataDisplay waits to load.
...
4. [https://vercel.com/blog/how-we-made-the-vercel-dashboard-twice-as-fast](https://vercel.com/blog/how-we-made-the-vercel-dashboard-twice-as-fast)
